export const messages = {
  ...
  'zh-CN': {
    ...
    dashboard: {
      ...
      machineChangeSuccess: '机器码更换Thành công',
      machineChangeFailed: '机器码更换Thất bại',
      userInfo: '用户信息',
      level: '会员等级',
      username: 'CP账户邮箱',
      expireTime: '到期时间',
    ...
    message: {
      ...
      passwordChangeSuccess: '密码修改Thành công',
      passwordChangeFailed: '密码修改Thất bại',
    },
    systemControl: {
      title: '系统控制',
      hookStatus: '客户端注入状态',
