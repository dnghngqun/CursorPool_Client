export const messages = {
  'vi-VN': {
    ...
    menu: {
      dashboard: 'Tổng quan',
      historyAccount: 'Lịch sử tài khoản',
    ...
    dashboard: {
      ...
      advancedModel: 'Sử dụng Model Cao cấp',
      normalModel: 'Sử dụng Model Thường',
      quickActions: 'Thao tác nhanh',
      changeAccount: 'Đổi tài khoản',
      changeMachineCode: 'Đổi mã máy',
      quickChange: 'Đổi nhanh (Tài khoản + Mã máy)',
      changeSuccess: 'Thay đổi thành công',
      changeFailed: 'Thay đổi thất bại',
      accountChangeSuccess: 'Đổi tài khoản thành công',
      accountChangeFailed: 'Đổi tài khoản thất bại',
      machineChangeSuccess: 'Đổi mã máy thành công',
      machineChangeFailed: 'Đổi mã máy thất bại',
      userInfo: 'Thông tin người dùng',
      level: 'Cấp độ thành viên',
      username: 'Tên đăng nhập',
      expireTime: 'Thời gian hết hạn',
      dailyUsage: 'Sử dụng hàng ngày',
      cursorInfo: 'Thông tin Cursor',
      cursorAccount: 'Tài khoản Cursor',
      cursorUsage: 'Sử dụng Cursor',
      notLoggedIn: 'Chưa đăng nhập',
      unlimited: 'Không giới hạn',
      serverNotConnected: 'Chưa kết nối máy chủ',
      codeUnused: 'Chưa sử dụng',
      codeExpired: 'Đã hết hạn',
      codeRefunded: 'Đã hoàn tiền',
      codeEnded: 'Đã kết thúc',
      memberLevel: {
        1: 'Người mới',
        2: 'Lập trình viên',
        3: 'Kỹ sư',
      ...
      newVersion: 'Phiên bản mới nhất',
      later: 'Để sau',
      downloadNow: 'Tải về ngay',
      unusedCreditsWarning: 'Nhắc nhở sử dụng',
      unusedCreditsMessage:
        'Bạn vẫn còn {count} lượt sử dụng model cao cấp. Bạn có chắc chắn muốn đổi tài khoản?',
      confirmSwitch: 'Xác nhận',
      cancelSwitch: 'Hủy',
      ccStatus: 'Trạng thái Cursor',
      registerTime: 'Thời gian đăng ký',
      insufficientCredits: 'Không đủ lượt sử dụng, vui lòng nạp thêm',
      email: 'Email',
      cpUsage: 'Lượt dùng CP',
      advancedModelUsage: 'Dùng Model Cao cấp',
      basicModelUsage: 'Dùng Model Cơ bản',
      cannotGetUsage: 'Không thể kết nối',
      cursorHistoryDownload: 'Tải các phiên bản Cursor cũ',
      cursorDbError: 'Cơ sở dữ liệu Cursor không tồn tại hoặc không có dữ liệu',
      cursorNetworkError: 'Lỗi kết nối mạng, vui lòng kiểm tra lại mạng',
      cursorDataError: 'Định dạng dữ liệu Cursor trả về không hợp lệ',
      cursorUnknownError: 'Lỗi Cursor không xác định, vui lòng khởi động lại phần mềm',
      cursorProUnlimitedTip:
        'Chính sách mới nhất của Cursor cho phép người dùng Pro và Pro Trial sử dụng model không giới hạn',
    },
    login: {
      title: 'Đăng nhập',
      emailPlaceholder: 'Nhập email của bạn',
      passwordPlaceholder: 'Nhập mật khẩu',
      smsCodePlaceholder: 'Nhập mã xác nhận',
      sendCode: 'Gửi mã',
      resendCode: 'Gửi lại sau {seconds}s',
      ...
      userExists: 'Email này đã được đăng ký, chuyển sang chế độ đăng nhập',
      userNotExists: 'Email này chưa được đăng ký, vui lòng đăng ký trước',
      emailInvalid: 'Vui lòng nhập địa chỉ email hợp lệ',
      emailUnsupported: 'Tên miền email này không được hỗ trợ',
      passwordInvalid: 'Mật khẩu phải chứa ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường và số',
    },
    settings: {
      ...
      closeMethod: 'Cách đóng ứng dụng',
      operationMode: 'Chế độ hoạt động',
      simpleMode: 'Chế độ đơn giản',
      advancedMode: 'Chế độ nâng cao',
      switchedToAdvanced: 'Đã chuyển sang chế độ nâng cao',
      switchedToSimple: 'Đã chuyển sang chế độ đơn giản',
      settingsFailed: 'Cài đặt thất bại',
      route: 'Đường truyền',
    },
    history: {
      ...
      clearFailed: 'Xóa lịch sử thất bại',
    },
    message: {
      pleaseInputActivationCode: 'Vui lòng nhập mã kích hoạt',
      activationSuccess: 'Kích hoạt thành công',
      activationFailed: 'Kích hoạt thất bại',
      pleaseInputEmail: 'Vui lòng nhập email',
      addSuccess: 'Thêm thành công',
      switchSuccess: 'Đã chuyển sang tài khoản: {email}',
      deleteSuccess: 'Xóa thành công',
      pleaseInputPassword: 'Vui lòng nhập đầy đủ các trường mật khẩu',
    ...
    systemControl: {
      ...
      hookStatus: 'Trạng thái Hook',
      hookApplied: 'Đã áp dụng',
      hookNotApplied: 'Chưa áp dụng',
      applyHook: 'Áp dụng Hook',
      restoreHook: 'Khôi phục Hook',
      updateStatus: 'Trạng thái tự động cập nhật',
      updateDisabled: 'Đã tắt',
      updateEnabled: 'Đang bật',
      disableUpdate: 'Tắt cập nhật',
      restoreUpdate: 'Bật lại cập nhật',
      clientStatus: 'Trạng thái Client',
      clientVerified: 'Đã xác minh',
      clientUnverified: 'Chưa xác minh',
      cursorPath: 'Đường dẫn Cursor: ',
      changePath: 'Đổi đường dẫn',
      systemNotification: 'Thông báo hệ thống',
      authorized: 'Đã cấp quyền',
      unauthorized: 'Chưa cấp quyền',
      requestPermission: 'Yêu cầu quyền',
      messages: {
        disableUpdateSuccess: 'Đã tắt tự động cập nhật thành công',
        restoreUpdateSuccess: 'Đã khôi phục tự động cập nhật thành công',
        applyHookSuccess: 'Áp dụng hook thành công',
        restoreHookSuccess: 'Khôi phục hook thành công',
        cursorRunning: 'Cursor đang chạy, vui lòng lưu công việc trước khi tiếp tục!',
        forceKillConfirm: 'Tôi đã lưu, đóng bắt buộc',
        permissionGranted: 'Đã cấp quyền thông báo',
        permissionDenied:
          'Quyền bị từ chối, vui lòng bật thông báo thủ công trong cài đặt hệ thống',
      },
    },
    about: {
      title: 'Giới thiệu',
      ...
      copyright: 'Bản quyền',
      license:
        'Mã nguồn mở theo giấy phép MIT. Phải giữ nguyên thông báo bản quyền khi sửa đổi hoặc phân phối.',
    ...
    common: {
      ...
      forceClose: 'Đóng bắt buộc',
      cursorRunning: 'Cursor đang chạy',
      cursorRunningMessage: 'Cursor đang chạy, vui lòng lưu dự án của bạn trước khi tiếp tục!',
      closingCursor: 'Đang đóng Cursor...',
      forgotPassword: 'Quên mật khẩu?',
      ...
      failed: 'Thất bại',
      loading: 'Đang tải...',
      confirmRestart: 'Khởi động lại ngay',
      timeUnknown: 'Không xác định',
    ...
    inbound: {
      title: 'Đường truyền',
      selector: 'Chọn đường truyền',
      switchSuccess: 'Đã chuyển sang đường truyền: {name}',
      switchFailed: 'Chuyển đường truyền thất bại',
      restartNeeded: 'Khuyến nghị khởi động lại ứng dụng để cấu hình đường truyền mới có hiệu lực',
      defaultInbound: 'Đường truyền mặc định',
      domestic: 'Đường truyền trong nước',
      foreign: 'Đường truyền quốc tế',
    },
    closeType: {
      ask: 'Hỏi mọi lúc',
      minimize: 'Thu nhỏ',
    ...
    historyAccount: {
      ...
      email: 'Email',
      machineCode: 'Mã máy',
      advancedModelUsage: 'Sử dụng Model Cao cấp',
      actions: 'Thao tác',
      switchButton: 'Chuyển',
      deleteButton: 'Xóa',
      refreshAll: 'Làm mới tất cả',
      clearHighUsage: 'Xóa lượt dùng cao',
      switchSuccess: 'Chuyển tài khoản thành công',
      switchFailed: 'Chuyển tài khoản thất bại',
      deleteSuccess: 'Xóa thành công',
      deleteFailed: 'Xóa thất bại',
      hookFailed: 'Tiêm hook thất bại, vui lòng thử tiêm thủ công',
      refreshSuccess: 'Đã làm mới tất cả tài khoản thành công',
      refreshPartial: 'Đã làm mới {success}/{total} tài khoản',
      refreshFailed: 'Làm mới lượt dùng thất bại',
      noHighUsageAccounts: 'Không có tài khoản lượt dùng cao nào để xóa',
      clearHighUsageSuccess: 'Đã xóa thành công {count} tài khoản lượt dùng cao',
      clearHighUsageFailed: 'Xóa tài khoản lượt dùng cao thất bại',
      loadFailed: 'Tải lịch sử tài khoản thất bại',
    },
    notification: {
      testTitle: 'Kiểm tra thông báo',
      testBody: 'Chúc mừng! Chức năng thông báo đã được kích hoạt thành công.',
    },
    network: {
      retrying: 'Đang thử lại {endpoint}, lượt {attempt}/{max}',
      refreshingInbound: 'Đang làm mới đường truyền...',
      inboundRefreshed: 'Đã làm mới đường truyền',
      requestFailed: 'Yêu cầu thất bại, đang thử lại kết nối',
  ...
  'zh-CN': {
    ...
    dashboard: {
      ...
      expiryDate: '会员到期时间',
      usageStats: '使用统计',
      advancedModel: 'Model cao cấp使用量',
      normalModel: 'Model cơ bản使用量',
      quickActions: '快捷操作',
      changeAccount: '更换账户',
      changeMachineCode: '更换机器码',
      quickChange: '一键更换(账户+机器码)',
      changeSuccess: '更换Thành công',
      changeFailed: '更换Thất bại',
      accountChangeSuccess: '账户更换Thành công',
      accountChangeFailed: '账户更换Thất bại',
      machineChangeSuccess: 'Đổi mã máyThành công',
      machineChangeFailed: 'Đổi mã máyThất bại',
      userInfo: '用户信息',
      level: '会员等级',
      username: 'CP账户邮箱',
      expireTime: '到期时间',
      ...
      unusedCreditsMessage:
        '您还有 {count} 次Model cao cấp使用次数Chưa sử dụng, 确定要切换账号吗？',
      confirmSwitch: 'Xác nhận切换',
      cancelSwitch: 'Hủy',
      ccStatus: '本地Curso状态',
      registerTime: '本地Cursor账户Đăng ký时间',
      insufficientCredits: '剩余额度不足, 请先充值',
      email: '本地Cursor邮箱',
      cpUsage: 'Cursor Pool额度使用量',
      advancedModelUsage: 'Model cao cấp使用量',
      basicModelUsage: 'Model cơ bản使用量',
      ...
      cursorUnknownError: 'CursorLỗi không xác định, 请重启软件',
    ...
    login: {
      ...
      noAccount: '还没有账户？',
      register: '立即Đăng ký',
      hasAccount: '已有账户？去Đăng nhập',
      userExists: '该邮箱已Đăng ký, 已切换到Đăng nhập模式',
      userNotExists: '该邮箱Chưa đăng ký, 请先Đăng ký账户',
    ...
    settings: {
      ...
      settingsFailed: '设置Thất bại',
      route: '线路',
    },
    history: {
      title: '操作记录',
      filter: '筛选',
      dateRange: '选择Khoảng ngày',
      type: '操作类型',
      detail: '详情',
      time: '时间',
      operator: '操作者',
      datePlaceholder: '选择Khoảng ngày',
      clearHistory: 'Xóa lịch sử记录',
      clearSuccess: '历史记录已清除',
      clearFailed: 'Xóa lịch sử thất bại',
    },
    message: {
      pleaseInputActivationCode: '请输入激活码',
      activationSuccess: '激活Thành công',
      activationFailed: 'Kích hoạt thất bại',
      pleaseInputEmail: '请输入账户邮箱',
      addSuccess: '添加Thành công',
      switchSuccess: '切换到账户: {email}',
      deleteSuccess: '删除Thành công',
      pleaseInputPassword: '请填写完整密码信息',
      passwordNotMatch: '两次输入的新密码不一致',
      passwordChangeSuccess: 'Đổi mật khẩuThành công',
      passwordChangeFailed: 'Đổi mật khẩuThất bại',
    },
    systemControl: {
      title: 'Điều khiển hệ thống',
      hookStatus: '客户端注入状态',
      ...
      messages: {
        applyHookSuccess: '注入客户端Thành công',
        restoreHookSuccess: '恢复客户端Thành công',
        cursorRunning: 'Cursor进程正在运行, Vui lòng đóng Cursor trước',
        forceKillConfirm: '我已保存, Bắt buộc关闭',
    ...
    common: {
      ...
      copyFailed: '复制Thất bại',
      forceClose: '我已保存, Bắt buộc关闭',
      ...
      forgotPassword: '忘记密码？',
      unknown: '未知',
      notBound: '本地Cursor没有Đăng nhập账户',
      verified: '已验证',
      unverified: '未验证',
      success: 'Thành công',
      failed: 'Thất bại',
    ...
    historyAccount: {
      ...
      switchSuccess: '切换账户Thành công',
      switchFailed: 'Đổi tài khoản thất bại',
      deleteSuccess: '删除Thành công',
      deleteFailed: '删除Thất bại',
      hookFailed: '注入Thất bại，请手动注入后再试',
      refreshSuccess: '所有账户刷新Thành công',
      refreshPartial: 'Thành công刷新 {success}/{total} 个账户',
      refreshFailed: 'Làm mới tình hình sử dụngThất bại',
      noHighUsageAccounts: '没有高使用量账户需要清理',
      clearHighUsageSuccess: 'Thành công清理 {count} 个高使用量账户',
      clearHighUsageFailed: '清理高使用量账户Thất bại',
      loadFailed: 'Tải tài khoản lịch sửThất bại',
    },
    notification: {
      testTitle: '通知测试',
      testBody: '恭喜！通知功能已Thành công启用。',
    },
    network: {
      retrying: '正在重试 {endpoint}，第 {attempt}/{max} 次',
      refreshingInbound: '正在刷新线路...',
      inboundRefreshed: '线路刷新完成',
      requestFailed: '请求Thất bại，正在尝试重新连接',
  ...
  'ja-JP': {
    ...
    dashboard: {
      ...
      quickChange: 'クイック変更',
      changeSuccess: '変更Thành công',
      changeFailed: '変更失敗',
      accountChangeSuccess: 'アカウント変更Thành công',
      accountChangeFailed: 'アカウント変更失敗',
      machineChangeSuccess: 'マシンコード変更Thành công',
    ...
    login: {
      ...
      sendCode: '認証コードを送信',
      resendCode: '{seconds}giây後に再送信',
      loginButton: 'ログイン',
      registerButton: '登録',
      forgotPassword: 'パスワードを忘れた場合',
      emailError: '有効なメールアドレスを入力してください',
      passwordError: 'パスワードを入力してください',
      loginSuccess: 'ログインThành công',
      loginFailed: 'ログイン失敗',
    ...
    common: {
      logout: 'ログアウト',
      copySuccess: 'コピーにThành côngしました',
    ...
    historyAccount: {
      ...
      switchSuccess: 'アカウント切り替えThành công',
      switchFailed: 'アカウント切り替え失敗',
      deleteSuccess: '削除Thành công',
      deleteFailed: '削除失敗',
      hookFailed: '注入失敗、手動での注入を試してください',
      refreshSuccess: 'モ든 アカウントが更新されました',
      refreshPartial: '{success}/{total} アカウントの更新にThành côngしました',
